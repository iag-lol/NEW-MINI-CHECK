export type TerminalSlug = 'El Roble' | 'La Reina' | 'María Angélica' | 'Los Agricultores'
...
export const TERMINAL_GEOFENCES: Geofence[] = [
  ...
  { name: 'Los Agricultores', lat: -33.475473691963046, lon: -70.76517915029181, radius: 360 },
]
