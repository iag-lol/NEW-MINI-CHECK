...
const badgeVariants = cva(
  'inline-flex items-center gap-1 rounded-full border px-2 py-0.5 text-[10px] font-bold uppercase leading-[1.35] tracking-[0.07em] backdrop-blur-md sm:px-2.5 sm:text-[10.5px]',
  {
    variants: {
      variant: {
