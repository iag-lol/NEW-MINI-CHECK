...
// PDF EJECUTIVO
// ============================================
// Vive en su propio módulo: es un informe de varias páginas con su propia
// recolección de datos y no comparte nada con los exportadores de Excel.

export { exportExecutivePdf } from '@/lib/pdf-ejecutivo'
